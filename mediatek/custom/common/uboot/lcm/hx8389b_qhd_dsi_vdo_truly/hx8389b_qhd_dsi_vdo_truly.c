...
//	{REGFLAG_DELAY, 10, {}},
    ...
    /*	{0XE0, 34,   {0X00,0x09,0x0D,0x22,0x2A,0x3F,0x1B,0x3E,
 	...
 	{0XE0, 34,   {0X00,0x09,0x0D,0x22,0x2A,0x3F,0x1B,0x3E,
                     0x07,0x0C,0x0F,0x12,0x14,0x11,0x13,0x15,
                     0x17,0x00,0x09,0x0D,0x22,0x2A,0x3F,0x1B,
                     0x3E,0x07,0x0C,0x0F,0x12,0x14,0x11,0x13,
                     0x15,0x17}},
...
{
           LCM_DBG("[MAGNUM] -- hx8389b lcm_init AAAAAA ");
	unsigned int id=0;
	unsigned int id1=0;
	unsigned char buffer[2];
	unsigned int array[16];  
	...
	id = buffer[0]; 
        id1 = buffer[0]<<8 |buffer[1]; 
        LCM_DBG("[MAGNUM] -- hx8389b lcm_init BBBBB ");
	LCM_DBG("[WUHAI] -- hx8389b 0x%x , 0x%x , 0x%x , 0x%x \n",buffer[0],buffer[1],id,id1);
...
LCM_DRIVER hx8389b_qhd_dsi_vdo_truly_lcm_drv = 
{
    .name			= "hx8389b_dsi_vdo_truly",
