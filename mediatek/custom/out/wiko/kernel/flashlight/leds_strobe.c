...
static int sgm3780_flashlight_ioctl(MUINT32 cmd, MUINT32 arg)
{
	int i4RetValue = 0;
	int ior;
	int iow;
	...
	PK_DBG("sgm3780_flashlight_ioctl() line=%d cmd=%d, ior=%d, iow=%d iowr=%d arg=%d\n",__LINE__, cmd, ior, iow, iowr, arg);
	PK_DBG("sgm3780_flashlight_ioctl() line=%d cmd-ior=%d, cmd-iow=%d cmd-iowr=%d arg=%d\n",__LINE__, cmd-ior, cmd-iow, cmd-iowr, arg);
    switch(cmd)
    {
...
static int sgm3780_flashlight_open(void *pArg)
{
    int i4RetValue = 0;
    PK_DBG("sgm3780_flashlight_open line=%d\n", __LINE__);
...
static int sgm3780_flashlight_release(void *pArg)
{
    PK_DBG(" sgm3780_flashlight_release\n");
...
FLASHLIGHT_FUNCTION_STRUCT	sgm3780FlashlightFunc=
{
	sgm3780_flashlight_open,
	sgm3780_flashlight_release,
	sgm3780_flashlight_ioctl
};
