...
const NVRAM_LENS_PARA_STRUCT OV8831AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 OV8831AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &OV8831AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pOV8831AF_getDefaultData = OV8831AF_getDefaultData;
