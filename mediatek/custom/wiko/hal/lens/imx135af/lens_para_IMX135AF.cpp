...
const NVRAM_LENS_PARA_STRUCT IMX135AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 IMX135AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &IMX135AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pIMX135AF_getDefaultData = IMX135AF_getDefaultData;
