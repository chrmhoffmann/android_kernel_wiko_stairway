...
#define OV12830_USE_OTP
#ifdef OV12830_USE_OTP
extern kal_bool otp_update_wb(unsigned short golden_rg, unsigned short golden_bg);
extern kal_bool otp_update_lenc(void);
...
UINT32 OV12830Open(void)
{
	...
	for(i=0;i<3;i++)
	{
	    ...
	    ov12830_write_id = ov12830.write_id;
	    if(sensor_id != OV12830_SENSOR_ID)
