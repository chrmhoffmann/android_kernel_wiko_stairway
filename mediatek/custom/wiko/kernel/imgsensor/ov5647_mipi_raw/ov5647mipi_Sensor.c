...
kal_uint16 OV5647MIPI_read_customer_mid(void)
{
    ...
    printk("OV5647MIPI_read_customer_mid, index == %d,customer_id == 0x%x.\n",index,customer_id);
    //disable otp read
...
UINT32 OV5647MIPIGetSensorID(UINT32 *sensorID) 
{
    ...
    *sensorID=((OV5647MIPI_read_cmos_sensor(0x300A) << 8) | OV5647MIPI_read_cmos_sensor(0x300B));
    ...
    {
	if (OV5647MIPI_read_customer_mid())
	    printk("OV5647MIPIGetSensorID,this is truly module.\n");
	else
	{
	    printk("OV5647MIPIGetSensorID,this is sunny module.\n");
            *sensorID = 0xFFFFFFFF;
            return ERROR_SENSOR_CONNECT_FAIL;
	}
    }
	...
	printk("OV5647MIPIGetSensorID, Try again with PWD High \n");
